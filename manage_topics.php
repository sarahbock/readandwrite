...
<head>
  ...
  <link href="css/all.min.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/scripts.js?v=32"></script>
		      ...
		      while($heading = $headings_result->fetch_assoc()) {
		        if ($heading['id']!=="0"){
		            ...
		            $str.='</tr>';
								...
								$str.='<button class="nostyle" onclick="addTopic(\''.$heading['id'].'\');"><i class="fas fa-plus-circle"></i></button>';
				...
				$str.='<div class="ta_buttons">';
				$str.='<button class="nostyle" onclick="addHeading();"><i class="fas fa-plus-circle"></i></button>';
