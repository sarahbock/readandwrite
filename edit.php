...
<head>
    ...
    <script type="text/javascript" src="js/scripts.js?v=61"></script>
...
<div class="containerScroll"> <!--scrollable content-->
    ...
    <div class="shading2<?php if ($language1!=='umpila') echo' invisible';?>">
        ...
        <div class="editRight"><div><div contenteditable="true" class="ta" onfocus="textAreaFocus(this);" onblur="textAreaBlur(this);" maxlength="500" data-id="<?php echo($rows[0]['id']);?>" data-field="meaning" placeholder="Type Creole here"><?php if ($language1==='umpila') echo($rows[0]['meaning']);?></div></div></div>
        <div class="clearBoth"></div>
    </div>
    ...
    <div class="shading2<?php if ($language1!=='mangarrayi') echo' invisible';?>">
        ...
        <div class="editRight"><div><div contenteditable="true" class="ta" onfocus="textAreaFocus(this);" onblur="textAreaBlur(this);" maxlength="500" data-id="<?php echo($rows[0]['id']);?>" data-field="kriol" placeholder="Type Kriol here"><?php if ($language1==='mangarrayi') echo($rows[0]['kriol']);?></div></div></div>
        <div class="clearBoth"></div>
    </div>
    ...
    <!-- DISPLAY ORDER (ONLY IN DHARUG)-->
    <div class="shading2<?php if ($language1!=='dharug' && $language1!=='sandpit') echo' invisible';?>"">
        <div class="editLeft"><div>Display order</div></div>
        <div class="editRight"><div><div contenteditable="true" class="ta" onfocus="textAreaFocus(this);" onblur="textAreaBlur(this);" maxlength="10" data-id="<?php echo($rows[0]['id']);?>" data-field="displayorder" placeholder="Type number here. Decimals allowed."><?php if ($language1==='dharug' || $language1==='sandpit') echo($rows[0]['displayorder']);?></div></div></div>
        <div class="clearBoth"></div>
    </div>
    ...
    <div class="shading2<?php if ($language1==='mangarrayi') echo' invisible';?>"">
        ...
        <div class="editRight"><div><div contenteditable="true" class="ta" onfocus="textAreaFocus(this);" onblur="textAreaBlur(this);" maxlength="500" data-id="<?php echo($rows[0]['id']);?>" data-field="notes" placeholder="Type notes here"><?php if ($language1!=='mangarrayi') echo($rows[0]['notes']);?></div></div></div>
        <div class="clearBoth"></div>
    </div>
     ...
     <div class="shading2<?php if ($language1!=='mangarrayi') echo' invisible';?>"">
        ...
        <div class="editRight"><div><div contenteditable="true" class="ta" onfocus="textAreaFocus(this);" onblur="textAreaBlur(this);" maxlength="500" data-id="<?php echo($rows[0]['id']);?>" data-field="info" placeholder="Type information here example notes about bush tucker"><?php if ($language1==='mangarrayi') echo($rows[0]['info']);?></div></div></div>
        <div class="clearBoth"></div>
    </div>
