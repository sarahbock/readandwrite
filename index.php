...
<head>
    ...
    <script type="text/javascript" src="js/scripts.js?v=54"></script>
     ...
     <!--  <a href="" onlick="resetMode();"><div class="modeButtonClose" id="modeButtonImportClose"><i class="fas fa-times"></i></div></a>
       ...
       <!--   <div class="modeButton disabled" id="modeButtonImport">
        ...
        <div class="tableHeader">
            ...
            <div class="col2">Break it down</div>
            <div class="col2"><span class="language2"></span> meaning</div>
            <?php if ($language1==='umpila') echo'<div class="col2">Creole</div>'?>
