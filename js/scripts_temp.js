...
$(document).ready(function(){
      ...
      if (filter==="class"){//if they have selected class from first filter dropdown list
        ...
        functions.forEach((item, i) => {
          if(item!==""&&item!=="0"&&item){
            ...
            classStr="";
            if(filterArray.indexOf(item.toLowerCase())!==-1){
              classStr=' class="selectBold"';
            }
  ...
  function uploadFile(field,id){
      ...
      if (files[0].name.indexOf('"')!==-1||files[0].name.indexOf("'")!==-1){
        alert("Make sure the name of the file does not include any punctuation symbols."); return false;
      }
